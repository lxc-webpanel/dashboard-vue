...
export const CONTAINER_DIALOG_OPEN = 'CONTAINER_DIALOG_OPEN';
export const CONTAINER_DIALOG_CLOSE = 'CONTAINER_DIALOG_CLOSE';
...
const containersGetters = {
  ...
  containerInDialog: (state, getters) => (state.dialog && getters.container(state.dialog)) || false, // eslint-disable-line max-len
...
const containersMutations = {
  ...
  [CONTAINER_DIALOG_OPEN]: (state, id) => {
    state.dialog = id;
  },
  [CONTAINER_DIALOG_CLOSE]: (state) => {
    state.dialog = null;
  },
...
const containersActions = {
  ...
  openContainerDialog({ commit }, id) {
    commit(CONTAINER_DIALOG_OPEN, id);
  },
  closeContainerDialog({ commit }) {
    commit(CONTAINER_DIALOG_CLOSE);
  },
